...
export const DELETE_POST_TYPE_SUCCESSED = 'DELETE_POST_TYPE_SUCCESSED';
export const DELETE_POST_TYPE_FAILED = 'DELETE_POST_TYPE_FAILED';
...
export const CHANGE_PROFILE_SUCCESSED = 'CHANGE_PROFILE_SUCCESSED';
export const CHANGE_PROFILE_FAILED = 'CHANGE_PROFILE_FAILED';
export const SET_CHANGE_PROFILE_LOADING = 'SET_CHANGE_PROFILE_LOADING';
export const SET_CHANGE_PROFILE_VISIBLE = 'SET_CHANGE_PROFILE_VISIBLE';
...
export const CREATE_POSTS_TYPE = 'CREATE_POSTS_TYPE';
export const CREATE_POSTS_TYPE_FAILED = 'CREATE_POSTS_TYPE_FAILED';
...
export const SET_LANGUAGE_SUCCESSED= 'SET_LANGUAGE_SUCCESSED';
