...
export const getWeatherApi = async (payload) => {
    ...
    console.log(`https://api.openweathermap.org/data/2.5/forecast?lat=${location[0]}&lon=${location[1]}&lang=${lang}&units=metric&appid=43dc5d16b1690e84e42b959f5d2c5ef0`);
